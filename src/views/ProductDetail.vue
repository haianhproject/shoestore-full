<template>
    ...
    <div class="row mb-5 border-top pt-5">
      <div class="col-lg-8">
        ...
        <div class="text-secondary lh-lg">
          ...
          <ul>
            <li>Thương hiệu: ShoeStore Official</li>
  ...
  <div class="modal-content-custom p-4 shadow-lg rounded-5 animate-zoom">
    ...
    <div class="row align-items-center bg-light rounded-4 p-3 mb-4">
      <div class="col-4">
...
const selectedSize = ref(40) // Mặc định size 40 phổ biến
const showSuccessModal = ref(false);

// Tập dữ liệu chung đồng bộ với Trang chủ
const mockData = [
...
const addToCart = () => {
  ...
  else { cart.push({ ...product.value, quantity: 1, size: selectedSize.value }); }
...
.modal-overlay {
  ...
  backdrop-filter: blur(8px); /* Làm mờ nền cực sang */
  z-index: 9999;
}
